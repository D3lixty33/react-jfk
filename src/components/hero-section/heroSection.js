...
const HeroSection = () => {
    ...
    return (
        <div className="flex w-full h-auto flex-row mt-9 items-center ">
            ...
            <div className="w-6/12 h-auto text-start p-4 align-middle">
                <h5 className="mb-3 text-BASE">COSA FACCIAMO</h5>
                <h3 className="mb-3 text-3xl font-medium">Specializzati nel settore dei componenti meccanici di precisione</h3>
